...
class ChooseCircuit extends StatefulWidget {
  final UserModel? profile;
  const ChooseCircuit({super.key, this.profile});

  @override
  State<ChooseCircuit> createState() => _ChooseCircuitState();
}

clear() async {}

class _ChooseCircuitState extends State<ChooseCircuit> {
